...
let package = Package(
  name: "FieldAgentTrackerMain",
  platforms: [
    .iOS(.v16)
  ],
  products: [
    .library(name: "FieldAgentTrackerMain", targets: ["FieldAgentTrackerMain"])
  ],
  dependencies: [
  ...
  targets: [
    ...
    .testTarget(
      name: "FieldAgentTrackerMainTests",
      dependencies: [
        .product(name: "RxCocoa", package: "RxSwift"),
        .product(name: "RxSwift", package: "RxSwift"),
        .target(name: "FieldAgentTrackerMain"),
      ],
      plugins: [
      ],
    )
